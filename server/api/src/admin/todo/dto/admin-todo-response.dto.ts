...
export class AdminReminderResponseDto {
...
export class AdminTodoDetailResponseDto {
  ...
  @ApiProperty({ type: [AdminReminderResponseDto], description: '미리 알림 목록' })
  reminders!: AdminReminderResponseDto[];
}

export class AdminTodoListItemDto {
  @ApiProperty({ description: '할일 ID' })
  id!: string;
  ...
  @ApiProperty({ description: '미발송 미리 알림 수' })
  pendingReminderCount!: number;
}

export class AdminTodoListResponseDto {
  @ApiProperty({ type: [AdminTodoListItemDto] })
  items!: AdminTodoListItemDto[];
